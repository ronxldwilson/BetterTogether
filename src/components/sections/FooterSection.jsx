      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><Link href="/terms" className="hover:text-white">Terms & Conditions (Coming Soon)</Link></li>
              <li><Link href="/privacy" className="hover:text-white">Privacy Policy (Coming Soon)</Link></li>
              <li><Link href="/disclaimer" className="hover:text-white">Disclaimer (Coming Soon)</Link></li>
            </ul>
          </div>
