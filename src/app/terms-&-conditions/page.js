  ...
  return (
    <>
      ...
      <main className='max-w-4xl mx-auto px-6 py-12'>
        ...
        <b>Overview</b>
        <p className='mb-4'>
          This website is operated by Better Together Wellness Pvt. Ltd.
          Throughout the site, the terms “we”, “us” and “our” refer to Better
          Together Wellness Pvt. Ltd. Better Together Wellness offers
        ...
        <p className='mb-4'>
          In no case shall Better Together Wellness Pvt. Ltd, our directors,
        ...
        <p className='mb-4'>
          You agree to indemnify, defend and hold harmless Better Together
          Wellness Pvt. Ltd and our parent, subsidiaries, affiliates, partners,
        ...
        <p className='mb-4'>
          Questions about the Terms of Service should be sent to us at queries.bettertogether@gmail.com
        </p>
      </main>
      <FooterSection />
    </>
