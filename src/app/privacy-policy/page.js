  ...
  return (
    <>
      ...
      <main className='max-w-4xl mx-auto px-6 py-12'>
        ...
        <p className='mb-4'>
          When you book an appointment from our platforn, we collect the personal information you give us such
        ...
        <p className='mb-4'>
          ...
          system. This information helps us to monitor analytics for our site and prevent attacks on the site. 
        </p>
        <p className='mb-4'>
        ...
        <p className='mb-4'>
          ...
          transaction, verify your credit card, book an appointment, we imply that you consent to our
        ...
        <p className='mb-4'>
          ...
          queries.bettertogether@gmail.com or mailing us at: WeWork 
          MG Road, 62/63 The Pavilion, Church Street, Bengaluru, KA 560001
        </p>
        <p className='mb-4'>
        ...
        <b>
          <p className='mb-4'>QUESTIONS AND CONTACT INFORMATION</p>
        </b>
        <p className='mb-4'>
          If you would like to: access, correct, amend or delete any personal
          information we have about you, register a complaint, or simply want
          more information contact us at queries.bettertogether@gmail.com or 
          by mail at WeWork MG Road, 62/63 The Pavilion, Church Street, Bengaluru, KA 560001
        </p>
      </main>
      <FooterSection />
    </>
